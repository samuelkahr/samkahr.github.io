...
function getConfig(path = './') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            throw error_1.wrapError('Unable to open typewriter.yml', err, `Failed due to an ${err.code} error (${err.errno}).`, configPath);
        }
...
function assertHasToken(cfg) {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield getToken(cfg);
        if (token) {
            return token;
        }
...
exports.assertHasToken = assertHasToken;
...
function getToken(cfg) {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield getTokenMetadata(cfg);
        return token ? token.token : undefined;
    });
}
exports.getToken = getToken;
function getTokenMethod(cfg) {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield getTokenMetadata(cfg);
...
function getTokenMetadata(cfg) {
    return __awaiter(this, void 0, void 0, function* () {
        const tokens = yield listTokens(cfg);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (cfg && cfg.scripts && cfg.scripts.token) {
            ...
            if (!tokenScriptCache[tokenScript]) {
                const { stdout } = yield exec(tokenScript).catch(err => {
                    return { stdout: '' };
                });
                if (!!stdout) {
