...
function runGenerator(generator, trackingPlan, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const context = Object.assign({}, rootContext, { isDevelopment: options.isDevelopment, language: options.client.language, typewriterVersion: options.typewriterVersion, tracks: [], objects: [] });
        // File output.
        const files = [];
        ...
        const traverseSchema = (schema, parentPath) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ([ast_1.Type.ANY, ast_1.Type.STRING, ast_1.Type.BOOLEAN, ast_1.Type.INTEGER, ast_1.Type.NUMBER].includes(schema.type)) {
                ...
                let o;
                [p, o] = yield generator.generateObject(client, schema, properties, parentPath);
                if (o) {
                    context.objects.push(Object.assign({ properties }, o));
                }
            }
